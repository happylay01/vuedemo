...
/* space */
const Brand = resolve => require(['../views/clinic/brand'], resolve);
const Clinic = resolve => require(['../views/clinic/clinic'], resolve);
const Space = resolve => require(['../views/clinic/space'], resolve);
  ...
  routes: [
        ...
        { path: '/401', component: Err401, hidden: true }, {
          ...
          children: [
              ...
              { path: 'index', component: Clinic, name: '诊所' },
              { path: 'space', component: Space, name: '空间' }
          ]
        }, {
          path: '/introduction',
          component: Layout,
